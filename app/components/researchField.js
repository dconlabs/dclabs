  ...
  const research_field = [
    {
      ...
      desc: "서비스의 초기 기획, 디자인, 출시 후 개선까지 전체 사이클을 책임집니다. 비즈니스 목표와 사용자 니즈를 조율하며, 시각적 아름다움을 넘어 제품의 기능적 문제 해결과 전반적인 방향성을 이끕니다.",
      enDesc: "Oversees the entire service lifecycle from concept to launch. They balance business goals with user needs, driving functional problem-solving and overall direction beyond mere visual aesthetics."
    },
    {
      title: "사용자 경험 디자이너",
      enTitle: "UX Designer",
      desc: "사용자가 제품이나 서비스를 이용하며 느끼는 총체적인 경험을 설계합니다. 리서치와 데이터를 바탕으로 불편함을 찾아내고, 더 쉽고 만족스럽게 목적을 달성할 수 있도록 논리적인 흐름을 만듭니다.",
      enDesc: "Designs the overall experience a user has with a service. By leveraging research and data, they identify pain points and create logical, intuitive user flows to ensure user satisfaction and ease of use."
    },
    {
      title: "인터랙션 디자이너",
    ...
    },
    {
      title: "UX 라이터",
      enTitle: "UX Writer",
      desc: "서비스 내 텍스트를 사용자 친화적으로 설계합니다. 복잡한 정보를 간결하고 명확하게 전달하여 사용자가 쉽게 이해하고 행동할 수 있도록 돕습니다.",
      enDesc: "Crafts user-friendly service copy. They translate complex information into clear and concise language to guide user actions effectively."
    },
    {
      title: "AI 프로덕트 매니저",
